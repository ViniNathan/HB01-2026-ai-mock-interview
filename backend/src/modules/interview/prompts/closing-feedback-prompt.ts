...
- If the candidate gave few or non-substantive replies (e.g. "não sei", "teste", one-word answers, or only asked for structure without answering), say so honestly. Strengths must reflect demonstrated answers, not hypothetical performance from the résumé.
